...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  ENDIF()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/rspamd" TYPE SHARED_LIBRARY FILES "/home/linux/rspamd/rspamd-0.8.1/src/client/librspamdclient.so")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/rspamd/librspamdclient.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/rspamd/librspamdclient.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/rspamd/librspamdclient.so"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES
    "/home/linux/rspamd/rspamd-0.8.1/src/client/rspamc-0.8.1"
    "/home/linux/rspamd/rspamd-0.8.1/src/client/rspamc"
    )
  FOREACH(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/rspamc-0.8.1"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/rspamc"
    ...
    IF(EXISTS "${file}" AND
      ...
      FILE(RPATH_CHANGE
           FILE "${file}"
           OLD_RPATH "/home/linux/rspamd/rspamd-0.8.1/src/libutil:/home/linux/rspamd/rspamd-0.8.1/src/client:/home/linux/rspamd/rspamd-0.8.1/contrib/http-parser:"
           NEW_RPATH "/usr/local/lib/rspamd")
      IF(CMAKE_INSTALL_DO_STRIP)
